...
ephy_sample_extension_init (EphySampleExtension *extension)
{
	...
	g_debug ("EphySampleExtension initialising");
}
...
*/
	g_debug ("EphySampleExtension finalising");
...
//	EphySampleExtension *extension = EPHY_SAMPLE_EXTENSION (ext);
	g_debug ("EphySampleExtension attach_window");
}
...
{
//	EphySampleExtension *extension = EPHY_SAMPLE_EXTENSION (ext);
	g_debug ("EphySampleExtension detach_window");
}
